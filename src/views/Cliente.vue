<template>
    <div class="fonds">
        ...
        <div class="tables2">
            ...
            <h2 class="autores">Tabla Cliente</h2>
        ...
        <div class="paginacion">
            <nav>
                <router-link to="/formularioCliente"  class="btn" >Crear</router-link >
            <ul >
...
export default {
    ...
    methods:{
        getRead(){
            ...
            .then((resp) => {
                console.log(resp);
                this.ClienteList = resp.data.content;
