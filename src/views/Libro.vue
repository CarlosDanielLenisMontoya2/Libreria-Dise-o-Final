<template>
    ...
    <div >
        <div class="tables">
            ...
            <h2 class="autores">Tabla Libro</h2>
        ...
        <div class="paginacion">
            <nav>
                <router-link to="/formularioLibro"  class="btn" >Crear</router-link >
            <ul >
...
export default {
    ...
    methods:{
        getRead(){
            ...
            .then((resp) => {
                console.log(resp);
                this.libroList = resp.data.content;
        ...
        editRouter(id){
            this.$router.push(`/edit-libro/${id}`);
        
            },
            visitarRouter(autorId){
                this.$router.push(`/visitar-autor/${autorId}`);
            },
